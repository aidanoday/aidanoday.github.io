...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),n?(0,Z.jsx)(Jl,{user:n,users:i,onLogout:()=>{Wl(null),r(null),a([])}}):(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(Vl,{ref:o}),(0,Z.jsx)(ql,{bgRef:o,onAuth:(e,t)=>{r(e),a(t)}})]})]}):(0,Z.jsx)(`div`,{style:{minHeight:`100vh`,background:Q.bg,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,Z.jsx)(`div`,{style:{fontFamily:Q.sans,fontSize:14,color:Q.textTertiary,animation:`pulse 1.5s ease infinite`},children:`Loading...`})})}(0,u.createRoot)(document.getElementById(`root`)).render((0,Z.jsx)(l.StrictMode,{children:(0,Z.jsx)(Yl,{})}));